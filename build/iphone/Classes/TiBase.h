...
// in simulator we redefine to format for MyTwitterClient Developer console
...
{\
	NSString * exceptionName = [@"org.mytwitterclient." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mytwitterclient";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMyTwitterClientNativeItemNone = -1, 
	UIMyTwitterClientNativeItemSpinner = -2,
	UIMyTwitterClientNativeItemProgressBar = -3,
	
	UIMyTwitterClientNativeItemSlider = -4,
	UIMyTwitterClientNativeItemSwitch = -5,
	UIMyTwitterClientNativeItemMultiButton = -6,
	UIMyTwitterClientNativeItemSegmented = -7,
	
	UIMyTwitterClientNativeItemTextView = -8,
	UIMyTwitterClientNativeItemTextField = -9,
	UIMyTwitterClientNativeItemSearchBar = -10,
	
	UIMyTwitterClientNativeItemPicker = -11,
	UIMyTwitterClientNativeItemDatePicker = -12,
	
	UIMyTwitterClientNativeItemInfoLight = -13,
	UIMyTwitterClientNativeItemInfoDark = -14,
	
	UIMyTwitterClientNativeItemDisclosure = -15,
	
	UIMyTwitterClientNativeItemContactAdd = -16
};
